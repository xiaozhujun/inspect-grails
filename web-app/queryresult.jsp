                        ...
                        <li id="c_inspecttagrfid"><h2>标签管理</h2>
                            <ul>
                                <li id="i_inspecttagrfid_new"><a title="添加 标签"
                                                                 href="../inspecttagrfids?userform">添加 标签</a></li>
