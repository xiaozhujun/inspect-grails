...
public class DbImpl {
    ...
    public List<PageInspectTable>getTyname(){
        Connection connection = ds.getConnection();
        PreparedStatement statement = null;
        ResultSet rs = null;//得到所有的设备类型
        String sql="select id,typename from device_type";
        List<PageInspectTable> list=new ArrayList<PageInspectTable>();
        try {
            statement = connection.prepareStatement(sql);
    ...
    public List<PageInspectTable> getRoleName(){
        Connection connection = ds.getConnection();
        PreparedStatement statement = null;
        ResultSet rs = null;//得到所有的人员类型
    ...
    public List<PageInspectTable> getTableName(){
        Connection connection = ds.getConnection();
        PreparedStatement statement = null;
        ResultSet rs = null;//得到所有的点检表
